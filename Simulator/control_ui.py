...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.timer.timeout.connect(self.pub_signal)
        ...
        rospy.Subscriber('/selfdrive/target_velocity', Float32, self.target_velocity_cb)
    ...
    def system_cb(self, msg):
        self.label_tab1.setText(self.message[int(msg.data[0])])
    ...
    def pub_signal(self):
        if self.sig_in:
            self.signal_pub.publish(Int8(self.sig))
        else:
            self.signal_pub.publish(Int8(0))
    ...
    def initUI(self):
        ...
        self.setWindowTitle('mobinha - Selfdrive')
